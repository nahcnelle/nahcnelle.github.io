import {ChatBubbleLeftRightIcon, DevicePhoneMobileIcon, EnvelopeIcon, MapPinIcon} from '@heroicons/react/24/outline';
...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-gradient-to-b from-blue-600 to-green-500" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6 items-center">
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          <ChatBubbleLeftRightIcon className="hidden h-16 w-16 text-white md:block" />
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-200 hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500',
